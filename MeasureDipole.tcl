#vmd -dispdev text -e DipoleMeasure.tcl -args GFD3_single_QM_mopac_QwikMD QMMM SingleDipole 1 1 1
...
for {set i 0} {$i < $numframes} {incr i} {
  ...
  for {set j 0} {$j < $NumberOfQM} {incr j} {
    ...
    set dipole [veclength [measure dipole [lindex $QMregions $j] debye geocenter]]
    append line $dipole ","
    }
